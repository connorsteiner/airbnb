...
SELECT listings.property_type as 'type', count(reviews.id) as 'reviews', MAX(reviews.date_reviewed) as 'last review'
FROM listings INNER JOIN reviews ON listing_id = listings.id
